...
describe('validateAge Unit Test Suits', () => {
  ...
  it('should reject person who is 17 years old', () => {
    const seventeenYearsAgo = new Date();
    seventeenYearsAgo.setFullYear(seventeenYearsAgo.getFullYear() - 17);
    
    const person = { birthDate: seventeenYearsAgo };
    const result = validateAge(person);
  ...
  it('should reject person who is 10 years old', () => {
    const tenYearsAgo = new Date();
    tenYearsAgo.setFullYear(tenYearsAgo.getFullYear() - 10);
    
    const person = { birthDate: tenYearsAgo };
    const result = validateAge(person);
  ...
  it('should reject person who just turned 17 (one day before 18th birthday)', () => {
    const almostEighteen = new Date();
    almostEighteen.setFullYear(almostEighteen.getFullYear() - 18);
    almostEighteen.setDate(almostEighteen.getDate() + 1); // Un jour après = 1 jour avant les 18 ans
    
    const person = { birthDate: almostEighteen };
    const result = validateAge(person);
